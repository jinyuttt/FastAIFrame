        ...
        public override void ChannelRead(IChannelHandlerContext context, object message)
        {
            ...
            if (buffer != null)
            {
               ...
               if(isInit)
                ...
                NetSocket netSocket = new NetSocket() { data = buffer.Array, LocalHost = localIP, LocalPort = localPort, RemoteHost = endPoint.Address.ToString(), RemotePort = endPoint.Port, channel = context.Channel };
