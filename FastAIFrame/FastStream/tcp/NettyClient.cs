...
{
    public delegate void RecviceData(NetSocket netSocket);
    public class NettyClient
    {
        ...
        BlockingCollection<NetSocket> netSockets = null;
      
      private  async Task RunClientAsync()
        {

            resetEvent = new ManualResetEvent(false);
            netSockets = new BlockingCollection<NetSocket>();
        ...
        public void  CallData(RecviceData recviceData)
        {
